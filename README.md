...
You need the [**Tampermonkey**](https://www.tampermonkey.net/) extension installed in your browser. It's available for all of them.

Then create a new script and copy and paste from the source here. Edit if you like!
...
\** This is general life advice, not a contest. No prizes will be awarded.

\*** Except what Geoff said about the boat, that wasn't right at all.
